package com.vrmlstudio.gen.util;
...
import com.vrmlstudio.common.core.constant.gen.GenConstants;
...
public class VelocityUtils {
    ...
    public static String getFileName(String template, GenTableDto genTable) {
        ...
        if (template.contains("dto.java.vm"))
            ...
            return StringUtils.format("vrmlstudio-ui/src/api/{}/{}/{}.js", moduleName, authorityName, businessName);
        else if (template.contains("auth.js.vm"))
            return StringUtils.format("vrmlstudio-ui/src/constants/auth/{}/{}/{}.auth.js", moduleName, authorityName, businessName);
        else if (template.contains("enum.js.vm"))
            return StringUtils.format("vrmlstudio-ui/src/constants/enums/{}/{}/{}.enum.js", moduleName, authorityName, businessName);

        else if (template.contains("index.vue.vm"))
            return StringUtils.format("vrmlstudio-ui/src/views/{}/{}/{}/index.vue", moduleName, authorityName, businessName);
        return "" ;
    }
