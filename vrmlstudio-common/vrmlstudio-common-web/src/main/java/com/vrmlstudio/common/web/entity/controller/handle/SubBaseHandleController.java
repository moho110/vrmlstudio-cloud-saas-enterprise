...
public abstract class SubBaseHandleController<D extends SubBaseEntity<S>, DS extends ISubBaseService<D, S>, S extends BaseEntity, SS extends IBaseService<S>> extends BaseController<D, DS> {
     ...
     *
     * @param d 待修改数据对象
     * @see com.vrmlstudio.common.web.entity.controller.SubBaseController#edit(D)
     */
     ...
     *
     * @param d 待修改数据对象
     * @see com.vrmlstudio.common.web.entity.controller.SubBaseController#editStatus(D)
     */
     ...
     * @see com.vrmlstudio.common.web.entity.controller.SubBaseController#batchRemove(List)
     */
