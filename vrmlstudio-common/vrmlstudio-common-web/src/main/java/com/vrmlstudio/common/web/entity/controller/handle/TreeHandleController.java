package com.vrmlstudio.common.web.entity.controller.handle;
...
import com.vrmlstudio.common.web.entity.service.ITreeService;
...
public abstract class TreeHandleController<D extends TreeEntity<D>, DS extends ITreeService<D>> extends BaseController<D, DS> {
     ...
     * @see com.vrmlstudio.common.web.entity.controller.TreeController#listExNodes(TreeEntity)
     */
     ...
     *
     * @param d 待新增数据对象
     * @see com.vrmlstudio.common.web.entity.controller.TreeController#add(D)
     */
     ...
     *
     * @param d 待修改数据对象
     * @see com.vrmlstudio.common.web.entity.controller.TreeController#edit(D)
     * @see com.vrmlstudio.common.web.entity.controller.TreeController#editForce(D)
     */
     ...
     * @see com.vrmlstudio.common.web.entity.controller.TreeController#batchRemove(List)
     */
