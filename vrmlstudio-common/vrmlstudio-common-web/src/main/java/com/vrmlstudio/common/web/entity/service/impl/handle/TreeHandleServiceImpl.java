...
public class TreeHandleServiceImpl<D extends TreeEntity<D>, DG extends TreeManager<D, DM>, DM extends TreeMapper<D>> extends BaseServiceImpl<D, DG, DM> {
     ...
     * @param parentId 父级Id
     * @param status   状态
     * @see com.vrmlstudio.common.web.entity.service.impl.TreeServiceImpl#insert(TreeEntity)
     * @see com.vrmlstudio.common.web.entity.service.impl.TreeServiceImpl#update(TreeEntity)
     */
     ...
     * @param Id     Id
     * @param status 状态
     * @see com.vrmlstudio.common.web.entity.service.impl.TreeServiceImpl#updateStatus(Serializable, String)
     */
