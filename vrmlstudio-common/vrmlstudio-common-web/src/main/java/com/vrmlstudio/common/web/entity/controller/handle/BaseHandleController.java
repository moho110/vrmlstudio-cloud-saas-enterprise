...
public abstract class BaseHandleController<D extends BaseEntity, DS extends IBaseService<D>> extends BasisController {
     ...
     * @see com.vrmlstudio.common.web.entity.controller.BaseController#batchRemove(List)
     * @see com.vrmlstudio.common.web.entity.controller.BaseController#batchRemoveForce(List)
     */
