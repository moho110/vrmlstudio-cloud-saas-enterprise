...
public abstract class SubBaseHandleManager<D extends SubBaseEntity<S>, DM extends SubBaseMapper<D, S>, S extends BaseEntity, SM extends BaseMapper<S>> extends BaseManager<D, DM> {
     ...
     * @param d            数据对象
     * @see com.vrmlstudio.common.web.entity.manager.SubTreeManager#selectByIdExtra(Serializable)
     */
     ...
     * @see com.vrmlstudio.common.web.entity.manager.SubTreeManager#checkExistSub(Serializable)
     * @see com.vrmlstudio.common.web.entity.manager.SubTreeManager#checkExistNormalSub(Serializable)
     */
     ...
     * @param d             数据对象
     * @see com.vrmlstudio.common.web.entity.manager.SubTreeManager#updateSubStatus(Serializable, String)
     * @see com.vrmlstudio.common.web.entity.manager.SubTreeManager#deleteSub(Serializable)
     */
