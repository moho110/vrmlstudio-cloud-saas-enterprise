...
import com.vrmlstudio.common.web.entity.controller.TreeController;
...
public abstract class SubTreeHandleController<D extends SubTreeEntity<D, S>, DS extends ISubTreeService<D, S>, S extends BaseEntity, SS extends IBaseService<S>> extends TreeController<D, DS> {
     ...
     *
     * @param d 待修改数据对象
     * @see com.vrmlstudio.common.web.entity.controller.SubTreeController#edit(D)
     */
     ...
     *
     * @param d 待修改数据对象
     * @see com.vrmlstudio.common.web.entity.controller.SubTreeController#editStatus(D)
     */
     ...
     * @see com.vrmlstudio.common.web.entity.controller.SubTreeController#batchRemove(List)
     */
