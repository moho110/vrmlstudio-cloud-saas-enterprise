...
import com.vrmlstudio.common.web.entity.service.impl.TreeServiceImpl;
...
public abstract class SubTreeHandleServiceImpl<D extends SubTreeEntity<D, S>, DG extends SubTreeManager<D, DM, S, SM>, DM extends SubTreeMapper<D, S>, S extends BaseEntity, SS extends IBaseService<S>, SM extends BaseMapper<S>> extends TreeServiceImpl<D, DG, DM> {
     ...
     * @param id     Id
     * @param status 状态
     * @see com.vrmlstudio.common.web.entity.service.impl.SubTreeServiceImpl#update(SubTreeEntity)
     * @see com.vrmlstudio.common.web.entity.service.impl.SubTreeServiceImpl#updateStatus(Serializable, String)
     */
