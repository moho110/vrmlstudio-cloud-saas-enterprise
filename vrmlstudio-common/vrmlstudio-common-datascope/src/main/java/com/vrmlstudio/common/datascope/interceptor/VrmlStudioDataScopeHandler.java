package com.vrmlstudio.common.datascope.interceptor;
...
@Aspect
@Component
public class VrmlStudioDataScopeHandler implements DataPermissionHandler {
    ...
    public Expression getSqlSegment(Expression where, String mappedStatementId) {
        ...
        com.vrmlstudio.system.api.model.DataScope scope = SecurityUtils.getDataScope();
